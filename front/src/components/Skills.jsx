...
const Skills = () => {
  ...
  return (
     <div className="w-full h-full  relative overflow-hidden" id="skill">
          ...
          >
              <h2 className="flex flex-col gap-1 items-center font-bold text-5xl sm:text-8xl  bg-linear-to-t from-purple-500 to-blue-400  p-1 bg-clip-text text-transparent ">
